...
Mobile.tap(findTestObject('Cart screen/btn_Clear all'), 0)

Mobile.waitForElementPresent(findTestObject('Cart screen/btn_Confirmation YES'), 0)

Mobile.tap(findTestObject('Cart screen/btn_Confirmation YES'), 0)
